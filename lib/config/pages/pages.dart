...
import 'package:chiroku_cafe/feature/manage_printer/binding/manage_printer_binding.dart';
import 'package:chiroku_cafe/feature/manage_printer/views/manage_printer_view.dart';
...
class Pages {
  static final routes = [
    ...
    // Printer Management Route
    GetPage(
      name: AppRoutes.managePrinter,
      page: () => const ManagePrinterView(),
      binding: ManagePrinterBinding(),
    ),
    GetPage(
