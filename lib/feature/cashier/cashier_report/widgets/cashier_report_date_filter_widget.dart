...
class CashierTransactionDateFilterSection extends StatelessWidget {
  final String selectedFilter;
  final DateTimeRange? customDateRange;
  final Function(String) onFilterSelected;
  final Future<void> Function() onCustomDateRangeTap;

  const CashierTransactionDateFilterSection({
    super.key,
    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const Icon(Icons.edit, size: 20, color: AppColors.brownNormal),
        ],
      ),
    ),
  );
