...
import 'package:chiroku_cafe/feature/admin/admin_edit_profile/widgets/admin_edit_profile_avatar_widget.dart';
...
class EditProfileView extends GetView<EditProfileController> {
  ...
  Widget _buildRoleField() {
    return Obx(() {
      ...
      final roleDisplay = role.substring(0, 1).toUpperCase() + role.substring(1);
